...
// Display some messages
 term_print("Japanese not supported yet... \n");
 term_print("Welcome to EvaMSX Kernel!\n");
 term_print("Willkommen im EvaMSX-Kernel!\n");
 term_print("Bienvenue sur le kernel EvaMSX!\n");
}